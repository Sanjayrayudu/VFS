...
<nav>
  ...
  <div class="containerp">
    <img src="./Assets/trans.jpg" alt="Image" class="image"/>
    <h2 class="heading" style={{    marginTop: "140px"}}>TRANSPORTATION</h2>
  </div>
  
  <h3 className='janjs'>TRANSPORTATION</h3>
  <div class="containerp1s">
    <div class="boxp">
      <img src="./Assets/tr.jpg" alt="Image"/>
    </div>
    <div class="boxp">
      <div class="boxp-content">
        <h4>OUR TRANSPORTATION FACILITIES.</h4>
        <p>We have train & air cargo facilities all over India. We transport our material after ice water chilling & packing.</p>
        <h4>OUR GOAL</h4>
        <p>Maintain high quality of our product & Delivering fresh form to our customer.</p>
      </div>
    </div>
  </div>
