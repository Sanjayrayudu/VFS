...
<nav>
      ...
      <div class="containerpp">
        <img src="./Assets/cccc1.jpg" alt="Image" class="image" />
        <h2 class="headingsss">Sea Prawns & Vanamei Prawns</h2>
      </div>
      <h3 className ="aspirinsss"  >Sea Prawns & Vanamei Prawns</h3>
      <div class="containerfs">
        <div class="cardf">
          <img src="./Assets/kg11.jpg" alt="Card 1" class="cardf-image" />
          <div class="cardf-content">
            <p>Tiger Prawns</p>
          </div>
        </div>
        <div class="cardf">
          <img src="./Assets/kg1.jpg" alt="Card 2" class="cardf-image" />
          <div class="cardf-content">
            <p>Red tiger prawns </p>
          </div>
        </div>
        <div class="cardf">
          <img src="./Assets/kg4.jpg" alt="Card 2" class="cardf-image" />
          <div class="cardf-content">
            <p>Kalanda prawns</p>
          </div>
        </div>
      ...
      <div class="containerfs">
        <div class="cardf">
          <img src="./Assets/kg5.jpg" alt="Card 1" class="cardf-image" />
          <div class="cardf-content">
            <p>Brown prawns</p>
          </div>
        </div>
        <div class="cardf">
          <img src="./Assets/kg6.jpg" alt="Card 2" class="cardf-image" />
          <div class="cardf-content">
            <p>Flower prawns</p>
          </div>
        </div>
        <div class="cardf">
          <img src="./Assets/kg7.jpg" alt="Card 2" class="cardf-image" />
          <div class="cardf-content">
            <p>White prawns</p>
          </div>
        </div>
      ...
      <div class="containerfs">
        <div class="cardf">
          <img src="./Assets/kg3.jpg" alt="Card 1" class="cardf-image" />
          <div class="cardf-content">
            <p>Norn white prawns</p>
          </div>
        </div>
        <div class="cardf">
          <img src="./Assets/us.jpg" alt="Card 2" class="cardf-image" />
          <div class="cardf-content">
            <p>Vanami prawns 100 count</p>
          </div>
        </div>
        <div class="cardf">
          <img src="./Assets/uss1.jpg" alt="Card 2" class="cardf-image" />
          <div class="cardf-content">
            <p>Vanami 20 count</p>
          </div>
        </div>
      ...
      <div class="containerfs">
        <div class="cardf">
          <img src="./Assets/uss2.jpg" alt="Card 1" class="cardf-image" />
          <div class="cardf-content">
            <p>Scampi fresh water prawns</p>
          </div>
        </div>
        <div class="cardf">
          <img src="./Assets/uss3.jpeg" alt="Card 2" class="cardf-image" />
          <div class="cardf-content">
            <p>10 count prawns</p>
          </div>
        </div>
        <div class="cardf">
          <img src="./Assets/4.jpg" alt="Card 2" class="cardf-image" />
          <div class="cardf-content">
            <p>Korameenu fish</p>
          </div>
        </div>
